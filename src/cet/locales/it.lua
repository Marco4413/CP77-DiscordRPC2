return {
    ...
    ["Common.LargeImageText"] = "Livello: {level}; Reputazione: {streetCred}",
    ...
    ["Common.LifePath.StreetKid"] = "Vita di Strada",
    ["Common.LifePath.Corporate"] = "Corporativo",
    ...
    ["Combat.State.NoWeapon"] = "Nessuna arma equipaggiata.",
